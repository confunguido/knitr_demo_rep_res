...
packagesUsed = c("tidyverse", "grDevices", "repmis", "xtable")
...
\begin{figure}[H]
  \centering
<<echo=FALSE, message = FALSE, warning=FALSE, out.width='9.5 cm'>>=
...
system("cd ../analysis/scripts; python3 report_figure_tornado_diagram.py")
@
\begin{figure}[H]
...
<<results='asis', echo=FALSE>>=
  library(xtable)
table_data = read.csv('../analysis/output/report_table_psa_results.csv')
xtable(table_data,label="table-tornado", caption = "Sensitivity analysis of cost-effectiveness", digits = 2)
